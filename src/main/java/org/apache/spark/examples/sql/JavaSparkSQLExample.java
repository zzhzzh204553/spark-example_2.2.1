...
public class JavaSparkSQLExample {
	...
	public static class Person implements Serializable {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 5833412442126075791L;
		private String name;
		private int age;
	...
	public static void main(String[] args) throws AnalysisException {
		// $example on:init_session$
		SparkSession spark = SparkSession.builder().config("spark.master", "local")
	...
	private static void runProgrammaticSchemaExample(SparkSession spark) {
		// $example on:programmatic_schema$
		// Create an RDD
		JavaRDD<String> peopleRDD = spark.sparkContext().textFile("src/main/resources/people.txt", 1)
				.toJavaRDD();
