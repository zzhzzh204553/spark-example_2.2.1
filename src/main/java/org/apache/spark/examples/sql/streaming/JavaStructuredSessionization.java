 ...
 * <p>
 * Usage: JavaStructuredNetworkWordCount <hostname> <port> <hostname> and <port> describe the TCP server that Structured
 ...
 * bin/run-example sql.streaming.JavaStructuredSessionization localhost 9999`
 */
public final class JavaStructuredSessionization {
	...
	public static void main(String[] args) throws Exception {
		...
		FlatMapFunction<LineWithTimestamp, Event> linesToEvents = new FlatMapFunction<LineWithTimestamp, Event>() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = 433119201179343406L;
		...
		MapGroupsWithStateFunction<String, Event, SessionInfo, SessionUpdate> stateUpdateFunc = new MapGroupsWithStateFunction<String, Event, SessionInfo, SessionUpdate>() {
			 ...
			 * 
			 */
			private static final long serialVersionUID = -188479862121208097L;
		...
		Dataset<SessionUpdate> sessionUpdates = events.groupByKey(event -> event.getSessionId(), Encoders.STRING()).mapGroupsWithState(stateUpdateFunc, Encoders.bean(SessionInfo.class),
	...
	public static class LineWithTimestamp implements Serializable {
		private static final long serialVersionUID = 2793859265103601052L;
		private String line;
	...
	public static class Event implements Serializable {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -8214883861723162285L;
	...
	public static class SessionInfo implements Serializable {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -1486460106528548762L;
		...
		public String toString() {
			return "SessionInfo(numEvents = " + numEvents + ", timestamps = " + startTimestampMs + " to "
					+ endTimestampMs + ")";
		}
	}
	...
	public static class SessionUpdate implements Serializable {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 2795194169351591283L;
		private String id;
