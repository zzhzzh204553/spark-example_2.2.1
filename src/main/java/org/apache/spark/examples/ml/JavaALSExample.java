...
public class JavaALSExample {
	...
	public static class Rating implements Serializable {
		 ...
		 * 
		 */
		private static final long serialVersionUID = 8136879891108448926L;
		private int userId;
		private int movieId;
	...
	public static void main(String[] args) {
		...
		// $example on$
		JavaRDD<Rating> ratingsRDD = spark.read().textFile("data/mllib/als/sample_movielens_ratings.txt").javaRDD()
